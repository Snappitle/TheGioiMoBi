		...
		<div  id="vienXam" class="container-fluid">
				<div class="row">
					<div class="col-md-2">	
						...
						<div class="radio">
							<input type="radio" name="cb1_5"><label class="font3">1-5 triệuu</label>
							<br/>
							<input type="radio" name="cb5_10"><label class="font3">5-10 triệuu</label>
							<br/>
							<input type="radio" name="cb10_15"><label class="font3">10-15 triệu</label>
							<br/>
							<input type="radio" name="cb15_20"><label class="font3">15-20 triệu</label>
							<br/>
							<input type="radio" name="cbtren20"><label class="font3">>20</label>
							<br/>
						</div>
