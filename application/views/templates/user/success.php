<body>
		<div id="vienxam" class="container-fluid">
			<div class="row">
				...
				<div class="col-md-2"><a href="/TheGioiMobi/login_controller/prelogin" class="dn" name="lLogin"><img id="ava" width="30px" height="30px" src="/TheGioiMobi/img/ava.jpg"/>$Ten</a></div>
